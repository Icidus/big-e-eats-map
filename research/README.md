...
- Batches 001–012: 120 vendor records checked.
- Five earlier pilot reviews imported; 125 vendor records checked in total.
- Batch 013: ten vendors reserved in `next-batch.json`; these are still pending.

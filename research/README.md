...
- Batches 001–011: 110 vendor records checked.
- Five earlier pilot reviews imported; 115 vendor records checked in total.
- Batch 012: ten vendors reserved in `next-batch.json`; these are still pending.

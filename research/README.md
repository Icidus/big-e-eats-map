...
- Batches 001–013: 130 vendor records checked.
- Five earlier pilot reviews imported; 135 vendor records checked in total.
- Batch 014: ten vendors reserved in `next-batch.json`; these are still pending.

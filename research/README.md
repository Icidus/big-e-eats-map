...
- Batches 001–014: 140 vendor records checked.
- Five earlier pilot reviews imported; 145 vendor records checked in total.
- Batch 015: ten vendors reserved in `next-batch.json`; these are still pending.

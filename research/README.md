...
- Batches 001–016: 160 vendor records checked.
- Five earlier pilot reviews imported; 165 vendor records checked in total.
- Batch 017: ten vendors reserved in `next-batch.json`; these are still pending.

...
const trustedFoodSources = new Set([
  ...
  "https://www.instagram.com/yankeeboybige/p/DcjqsrpuDvi/",
  ...
  "https://www.instagram.com/soul_fully_vegan/p/Ddb8uH0RyAG/",
  "https://www.mackenssliders.com/",
...
describe("2026 catalog content", () => {
  ...
  it("defines the ordered editorial collections", () => {
    const expectedCollections = [
      ...
      ["bargain-bites-day", ["captain-nemos-savory-snack-wrap", "indian-restaurant-mixed-veggie-pakora", "west-springfield-lions-bacon-cheeseburger", "golden-kdog-cinnamozz-ball", "ny-style-pizza-hot-honey-chicken-pizza", "sugar-shakers-small-funnel-cake", "the-big-cheese-cheese-curds", "poutine-gourmet-mini-poutine", "kora-milas-cookie-dough-stick", "french-fry-corndog", "funnel-cake-waffle-cone", "carnival-candy-cotton-candy", "midway-slice-of-cheese-pizza", "rudys-slush-regular-slush", "pickle-barrel-sirloin-tips-side-of-mushrooms", "boardwok-noodles-noodle-or-rice-sampler", "chocolate-moonshine-hand-painted-truffle-bar", "chocolate-moonshine-pecan-caramel-explosion", "jungle-juice-smoothies-java-jungle-mango-lemon-refresher", "luanns-bakery-mini-funfetti-cupcakes", "spudtastic-sweet-potato-fries", "apple-fries-creamsicle-slush", "calabrese-artery-clogger", "crave-strawberry-mojito-sparkling-boba", "new-england-craft-beer-pub-cheeseburger-nachos", "nola-cajun-kitchen-and-raw-bar-chicken-etouffee", "soup-r-bowl-chili", "las-kangris-food-truck-baked-pork", "anna-s-fried-dough-fried-dough-bites", "pig-park-bbq-memphis-ribs", "amys-sweet-treats-ice-cream", "rudys-pizza-pizza", "granville-country-store-mac-and-cheese", "moose-joose-small-slush", "super-dog-mini-corndog", "angelas-pizza-soft-baked-chocolate-chip-cookie", "wisconsin-hot-cheese-jalapeno-cheddar-bites", "soup-r-bowl-clam-chowder", "soup-r-bowl-cream-of-broccoli-soup", "ferrindino-maple-cotton-candy", "fluffys-donut-holes", "ebs-deep-fried-brussels-sprouts", "macho-taco-watermelon-agua-fresca", "the-hub-small-cheese-fries", "butcher-boys-italian-sausage-bites", "butcher-boys-mini-kabob-bites", "white-hut-plain-hot-dog", "wurst-haus-pretzel-bites-beer-cheese", "jacks-fries-hot-dog", "reds-red-apples-small-popcorn", "agawam-lions-club-corn-on-the-cob", "the-paddock-small-sweet-potato-fries", "ultimate-bbq-cornbread", "barbies-flavor-blend-ice-cream-cone", "calabrese-market-limeade", "calabrese-market-kettle-corn", "calabrese-market-popcorn", "yankee-boy-corn-on-the-cob", "sweet-salty-cotton-candy"]],
      ["maine-food-stops", [
  ...
  "Creamsicle Slush",
  "The Artery Clogger",
  "Strawberry Mojito Sparkling Boba",
  "Cheeseburger Nachos",
  "Chicken Etouffee",
  "Chili",
  "Baked Pork",
  ...
  "Maple Cotton Candy",
  "Glazed or Cinnamon-Sugar Donut Holes",
